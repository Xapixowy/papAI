...
@Injectable()
export class SonarrHttpClientService {
  private host: string;
  private port: number;
  ...
  constructor(private readonly configService: ConfigService) {
    this.host = this.configService.get<string>('SONARR_HOST')!;
    this.port = this.configService.get<number>('SONARR_PORT')!;
    this.apiKey = this.configService.get<string>('SONARR_API_KEY')!;
