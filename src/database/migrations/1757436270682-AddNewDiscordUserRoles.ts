...
export class AddNewDiscordUserRoles1757436270682 implements MigrationInterface {
    name = 'AddNewDiscordUserRoles1757436270682'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            CREATE TYPE "public"."discord_user_role" AS ENUM('super_admin', 'chatgpt', 'radarr', 'sonarr')
        `);
        await queryRunner.query(`
