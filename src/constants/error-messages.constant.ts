...
export const ErrorCodeMessageMap: Record<ErrorCode, string> = {
  ...
  [ErrorCode.DISCORD_GUILD_CONFIG_NOT_FOUND]: 'Guild config not found.',
  [ErrorCode.DISCORD_GUILD_CONFIG_UNABLE_TO_CREATE]:
    'Guild config unable to create.',
  [ErrorCode.DISCORD_GUILD_CONFIG_UNABLE_TO_UPDATE]:
    'Guild config unable to update.',
};
